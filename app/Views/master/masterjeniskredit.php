				...
				?>
					<tr>
						...
						<td>
							...
							<a href="<?= base_url('MasterJKredit/delete/'.$row->id); ?>" onClick="return confirm('Hapus data Master <?= $row->nama?>?')" class="btn btn-light  btn-icon-split btn-sm"><img src="img/delete.png" width="20px" height="20px"alt="Delete"> </a>
						</td>				
					</tr>
					<?php
					$no++;	
