				...
				?>
					<tr>
						...
						<td>
							...
							<a href="<?= base_url('Masterbungadepsito/delete/'.$row->id); ?>" class="btn btn-danger"><i class="fas fa-plus"></i> Delete</a>
						</td>				
					</tr>
					<?php
						}
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">  
                    <div class="form-group">  
						...
						<div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0"> 
							<label class="col-form-label col-md-3 col-sm-3 label-align">Keterangan Waktu</label>
                                <div class="col-md-6 col-sm-6">
                                    <select name="ketrangan" class="form-control" required>
                                        <option value="">--Keterangan Waktu--</option>
