			...
			<table class="table table-bordered" id ="myTable">
				...
				?>
					<tr>
						...
						<td>
							<a href="<?= base_url('kaskeluar/delete/'.$row->nomor); ?>" onClick="return confirm('Hapus data kas tanggal <?= substr($row->created_at,0,10)?>?')" class="btn btn-light  btn-icon-split btn-sm"> <img src="img/delete.png" width="20px" height="20px"alt="Delete">  </a>
						</td>	
					</tr>
					<?php
					$no++;	
