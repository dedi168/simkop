                    ...
                    <div class="row"> 
                        <div class="col-lg">
                            <div class="p-5">
                                ...
                                <form action="<?= base_url('detaildeposito/update/'.$deposito->id) ?>" method="post" class="user">
                                <?= csrf_field() ?>  
                                <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0"> 
                                            <div class="input-group mb-2 mr-sm-2">
                                                ...
                                                <input readonly type="text" class="form-control" name="opr" value="<?= $deposito->opr;?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-6 mb-3 mb-sm-0"> 
                                            <div class="input-group mb-2 mr-sm-2">
                                                ...
                                                <input readonly type="text" class="form-control" name="tgl" value="<?= $deposito->tgl;?>">
                                          </div>
                                        </div>
                                    </div> 
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6 mb-3 mb-sm-0"> 
                                            <div class="input-group mb-2 mr-sm-2">
                                                ...
                                                <input type="text" class="form-control" id="jumlah"name="jumlah"  autocomplete="off" value="<?= $deposito->jumlah;?>" onFocus="startCalc();" onBlur="stopCalc();"> 
                                            </div>
                                        </div>
                                    </div> 
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0"> 
                                            <div class="input-group mb-2 mr-sm-2">
                                                ...
                                                <input type="text" class="form-control" name="nama" id="nama" value="<?= $deposito->nama;?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-6 mb-3 mb-sm-0"> 
                                            <div class="input-group mb-2 mr-sm-2">
                                                ...
                                                <input type="text" class="form-control" id="jatuh_tempo" name="jatuh_tempo" value="<?= $deposito->jatuh_tempo;?>">
                                            </div>
                                        </div>
                                    </div> 
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0"> 
                                            <div class="input-group mb-2 mr-sm-2">
                                                ...
                                                <input type="text" class="form-control" name="bunga" id="bunga"  autocomplete="off" value="<?= $deposito->bunga;?>" onFocus="startCalc();" onBlur="stopCalc();">
                                            </div>
                                        </div>
                                        <div class="col-sm-6 mb-3 mb-sm-0"> 
                                            <div class="input-group mb-2 mr-sm-2">
                                                ...
                                                <input type="text" class="form-control" name="no_tabungan" id="no_tabungan" value="<?= $deposito->no_tabungan;?>" placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                    </div> 
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0"> 
                                            <div class="input-group mb-2 mr-sm-2">
                                                ...
                                                <input type="text" class="form-control" name="sistem" id="sistem" placeholder="" value="<?= $deposito->sistem;?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-6 mb-3 mb-sm-0"> 
                                            <div class="input-group mb-2 mr-sm-2">
                                                ...
                                                <input type="text" class="form-control" name="jangka_waktu" id="jangka_waktu" value="<?= $deposito->jangka;?>" >
                                                <div class="input-group-prepend">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0"> 
                                            <div class="input-group mb-2 mr-sm-2">
                                                ...
                                                <input type="text" class="form-control" name="tanggal" id="tanggal"   value="<?= $deposito->tgl;?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-6 mb-3 mb-sm-0"> 
                                            <div class="input-group mb-2 mr-sm-2">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6 mb-3 mb-sm-0"> 
                                            <div class="input-group mb-2 mr-sm-2">
                                                ...
                                                <input type="text" class="form-control" id="saldo"name="saldo" value="<?= $deposito->saldo;?>">
                                                <!-- simpanan -->
                                                ...
                                                ?> 
                                                <input type="hidden" id="bungaS" name="bungaS" class="form-control "readonly autocomplete="off">
                                                <input type="hidden" id="simpan" name="simpan" class="form-control "readonly autocomplete="off">
