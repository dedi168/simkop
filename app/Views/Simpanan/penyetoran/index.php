			...
			<table class="bordered"  id="myTable">
				...
				?>
					<tr>
						...
						<td>
							<a href="<?= base_url('DetailSimpanan/edit/'.$row->id); ?>" class="btn btn-warning"><i class="fas fa-plus"></i> Edit</a>
							<a href="<?= base_url('DetailSimpanan/delete/'.$row->id); ?>" class="btn btn-danger"><i class="fas fa-plus"></i> Delete</a>
						</td>				
					</tr>
					<?php
					$no++;	
